...
fetch('/search-index.json').then(r=>r.json().then(pages=>{
  ...
  var search = document.querySelector('.textsearch');
  search.innerHTML = `
    <p><input type="search" id="search-box" placeholder="Type to search..." /></p>
  ...
  searchBox.addEventListener('keyup', (e)=>{
    ...
    resultsWrapper.innerHTML = results.map(r => `<li><a href="/${r.ref}">${r.ref}</a></li>`).join('');
  });
}));
